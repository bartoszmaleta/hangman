# TODO: 
# something wrong with chances = len_of_password
...
while user_answer == 'y' or user_answer == 'Y':  # do better caseSensitive
    ...
    def extract_from_file(filename):   
        ...
        with open(filename) as file_txt_of_cc:
            ...
            password = capital
        return chances, country, password
    
    from_extract = extract_from_file('countries-and-capital.txt')
    password = from_extract[2]
    chances = from_extract[0]
    country = from_extract[1]
